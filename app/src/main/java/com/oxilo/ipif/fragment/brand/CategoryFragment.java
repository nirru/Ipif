...
public class CategoryFragment extends Fragment  {
    ...
    private void initClassRefrence() {
        ...
        categoryListAdapter = new CategoryListAdapter(R.layout.category_cell_row, services,getContext());
                    ...
                    .subscribe(new Consumer<Response<ResponseBody>>() {
                        ...
                        public void accept(@NonNull Response<ResponseBody> brand) throws Exception {
                            try {
                                ...
                                for (Service brandList : services) {
                                    categoryListAdapter.addItem(brandList);
                                }
