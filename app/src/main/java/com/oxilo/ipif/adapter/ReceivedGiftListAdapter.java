 ...
 */
public class ReceivedGiftListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ReceivedGiftListAdapter(int inflated_row, List<T> productLists, Context mContext) {
