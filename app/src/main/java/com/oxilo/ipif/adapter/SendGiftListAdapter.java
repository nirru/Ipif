 ...
 */
public class SendGiftListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public SendGiftListAdapter(int inflated_row, List<T> productLists, Context mContext) {
